...
const ViewScheduleDialog = ({
    ...
    const scheduleDetails =
        data && data.success
            ? {
                  ...
                  ...data.data,
                  appointments:
                      data.data.appointments ?? schedule?.appointments,
                  doctorSchedules:
    ...
    const bookedCount =
        scheduleDetails?.doctorSchedules?.filter((item: any) => item.isBooked)
            .length ?? 0;
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-[90vh] w-[calc(100vw-1.5rem)] max-w-4xl gap-0 overflow-hidden p-0">
                <DialogHeader className="border-b px-6 py-5 pr-14">
                    ...
                    <DialogDescription>
                        Review schedule timing, doctor assignments, and linked
                        appointments.
                    </DialogDescription>
                </DialogHeader>
